...
export default async function ContactDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-4">
      ...
      <form action={replyContactSubmission.bind(null, submission.id)} className="rounded-xl border border-stone-200 bg-white p-6 shadow-xs">
        ...
        <button type="submit" className="mt-4 rounded-full bg-[#B72020] px-5 py-3 text-sm font-semibold text-white">寄出回覆</button>
      </form>
    </div>
  );
}